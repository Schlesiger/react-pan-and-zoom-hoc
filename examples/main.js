    ...
    render() {
        ...
        >
            ...
            <div style={{
                ...
                transform: `translate(${(x - 0.5) * 500}px, ${(y - 0.5) * 500}px) scale(${1 / scale})`
            }} />
            ...
            <div style={{
                ...
                transform: `translate(250px, 250px) translate(-25px, -25px)`
            }} />
            <div style={{
                position: 'absolute',
                width: 50,
            ...
            <div style={{
                ...
                transform: `translate(${p1.x * 500}px, ${p1.y * 500}px) translate(${-25 * scale}px, ${-25 * scale}px)`
            }} />
            <div style={{
                position: 'absolute',
                width: 50 * this.state.scale,
